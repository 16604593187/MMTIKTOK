...
func (c *videoRpcClient) PublishVideo(ctx context.Context, in *PublishVideoReq, opts ...grpc.CallOption) (*PublishVideoResp, error) {
	...
	err := c.cc.Invoke(ctx, VideoRpc_PublishVideo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoRpcClient) GetPublishList(ctx context.Context, in *PublishListReq, opts ...grpc.CallOption) (*PublishListResp, error) {
	...
	err := c.cc.Invoke(ctx, VideoRpc_GetPublishList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoRpcClient) GetFeed(ctx context.Context, in *FeedReq, opts ...grpc.CallOption) (*FeedResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FeedResp)
	err := c.cc.Invoke(ctx, VideoRpc_GetFeed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoRpcClient) CommentAction(ctx context.Context, in *CommentReq, opts ...grpc.CallOption) (*CommentResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommentResp)
	err := c.cc.Invoke(ctx, VideoRpc_CommentAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoRpcClient) GetCommentList(ctx context.Context, in *CommentListReq, opts ...grpc.CallOption) (*CommentListResp, error) {
	...
	err := c.cc.Invoke(ctx, VideoRpc_GetCommentList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoRpcClient) FavoriteAction(ctx context.Context, in *FavoriteReq, opts ...grpc.CallOption) (*FavoriteResp, error) {
	...
	err := c.cc.Invoke(ctx, VideoRpc_FavoriteAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoRpcClient) GetFavoriteList(ctx context.Context, in *FavoriteListReq, opts ...grpc.CallOption) (*FavoriteListResp, error) {
	...
	err := c.cc.Invoke(ctx, VideoRpc_GetFavoriteList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedVideoRpcServer must be embedded to have
...
func (UnimplementedVideoRpcServer) testEmbeddedByValue()                  {}
...
func RegisterVideoRpcServer(s grpc.ServiceRegistrar, srv VideoRpcServer) {
	// If the following call panics, it indicates UnimplementedVideoRpcServer was
